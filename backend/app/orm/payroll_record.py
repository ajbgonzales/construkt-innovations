...
class PayrollRecord(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "payroll_period_id", "employee_id", name="uq_payroll_record_period_employee"
        ),
    )
    ...
    payroll_period_ref = relationship("PayrollPeriod", back_populates="payroll_records")
    ...
    attendance_days: Mapped[list[AttendanceDay]] = relationship(
        back_populates="payroll_record_ref", cascade="all, delete-orphan"
    )
